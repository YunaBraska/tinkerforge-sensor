...
* [UNDER_VOLTAGE (ValueType)](src/main/java/berlin/yuna/tinkerforgesensor/model/type/ValueType.java) [x = mV] voltage too low
* [VOLTAGE (ValueType)](src/main/java/berlin/yuna/tinkerforgesensor/model/type/ValueType.java) [x = mV] output voltage change
### Technical Info
