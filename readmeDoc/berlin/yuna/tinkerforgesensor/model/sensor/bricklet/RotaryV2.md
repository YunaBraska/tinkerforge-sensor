...
## berlin.yuna.tinkerforgesensor.model.sensor.bricklet.RotaryV2
...
### [RotaryV2](https://github.com/YunaBraska/tinkerforge-sensor/blob/master/readmeDoc/berlin/yuna/tinkerforgesensor/model/sensor/bricklet/RotaryV2.md) ([source](src/main/java/berlin/yuna/tinkerforgesensor/model/sensor/bricklet/RotaryV2.java))

*360° rotary encoder with push-button*

### Values

* [ROTARY](https://github.com/YunaBraska/tinkerforge-sensor/blob/master/readmeDoc/berlin/yuna/tinkerforgesensor/model/type/ValueType.md) ([source](src/main/java/berlin/yuna/tinkerforgesensor/model/type/ValueType.java)) [x = number]
