...
public class IO16 extends Sensor<BrickletIO16> {
    ...
    /**
     * <br /> {@link berlin.yuna.tinkerforgesensor.model.driver.bricklet.Sensor.LedStatusType#LED_ADDITIONAL_ON} / {@link berlin.yuna.tinkerforgesensor.model.driver.bricklet.Sensor.LedStatusType#LED_ADDITIONAL_OFF} = all LEDs on/off
     * <br /> [0] = all LEDs off
     * <br /> [1] = all LEDs on
    ...
    @Override
    protected Sensor<BrickletIO16> flashLed() {
        try {
            ledAdditionalOff();
            for (int i = 1; i < 33; i++) {
