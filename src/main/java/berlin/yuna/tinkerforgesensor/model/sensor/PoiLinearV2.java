 ...
 */
public class PoiLinearV2 extends Sensor<BrickletLinearPotiV2> {

    public PoiLinearV2(final Device device, final String uid) throws NetworkConnectionException {
