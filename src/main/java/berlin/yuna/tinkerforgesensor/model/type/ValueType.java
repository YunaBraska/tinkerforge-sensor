...
public enum ValueType {
    ...
    public boolean containsBeep() {
        return this.is(BEEP) || (this.parent != null && this.parent.contains(BEEP));
    }
