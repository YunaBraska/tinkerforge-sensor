...
public enum ValueType {
    ...
    public boolean isDecibel() {
        return this == DECIBEL;
    }

    public boolean containsDecibel() {
        return this.is(DECIBEL) || (this.parent != null && this.parent.contains(DECIBEL));
    }
