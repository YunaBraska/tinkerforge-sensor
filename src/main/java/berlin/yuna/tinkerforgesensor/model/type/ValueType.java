...
public enum ValueType {
    ...
    public boolean containsHeading() {
        return this.is(HEADING) || (this.parent != null && this.parent.contains(HEADING));
    }
