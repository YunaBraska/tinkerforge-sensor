...
public class GeneratorEnumValueType {
    ...
    public static JavaFile generate() {
        ...
        javadoc.append("contains a list of all ").append("{@link ").append(className).append("} for Sensor values").append(SEPARATOR);
        ...
        for (ValueType valueType : ValueType.values()) {
            javadoc.append("<li>").append(valueType.toString()).append("</li>");
