...
public class GeneratorSensorHelper {
    ...
    public static JavaFile generate(final List<Class<? extends Sensor>> sensorList) {
        ...
        String autogenerated = "Autogenerated with [" + trace.getFileName().replace(".java",
                                                                                    "") + ":" + trace.getMethodName() + "]";

        //CREATE CLASS
        TypeSpec.Builder sensorHelper = TypeSpec.classBuilder(SensorTypeHelper.class.getSimpleName())
                .addModifiers(PUBLIC)
        ...
        FieldSpec sensorField = FieldSpec.builder(Sensor.class, "sensor", PUBLIC, FINAL).build();
    ...
    private static MethodSpec method_isSensor(final Class<? extends Sensor> sensor, final List<Class<? extends Sensor>> sensorVersions) {
        MethodSpec.Builder method = MethodSpec.methodBuilder("is" + getBasicSensorName(sensor.getSimpleName()))
                .addModifiers(PUBLIC)
                .returns(boolean.class);


        String returnLine = "return " + sensorVersions.stream()
