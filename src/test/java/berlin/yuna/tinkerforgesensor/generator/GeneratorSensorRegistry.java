...
public class GeneratorSensorRegistry {
    ...
    public static JavaFile generate(final List<JFile> sensors) {
        final String className = SensorRegistry.class.getSimpleName();
        ...
        javadoc.append("<h3>{@link ").append(className).append("}</h3>").append(SEPARATOR);
        javadoc.append("contains mapping of ").append("{@link ").append("$T").append("} and ").append("{@link ").append("$T").append("}").append(SEPARATOR);
        javadoc.append("<i>Autogenerated with [").append(trace.getFileName().replace(".java", "")).append(":").append(trace.getMethodName()).append("]").append(SEPARATOR);
        javadoc.append("You can add new enumTypes without harm</i>").append(SEPARATOR).append(SEPARATOR).append("---").append(SEPARATOR);
        javadoc.append("<ul>").append(SEPARATOR);
        for (JFile sensor : sensorList) {
            javadoc.append("<li>Device ").append("{@link ").append(sensor.getGenericClass().getSimpleName()).append("} => Sensor ").append("{@link ").append(sensor.getClazz().getSimpleName()).append("}</li>").append(SEPARATOR);
        }
        javadoc.append("</ul>");
        ...
        //CREATE CLASS
        final TypeSpec.Builder resultClass = TypeSpec.classBuilder(className)
                .addModifiers(PUBLIC)
                .addJavadoc(javadoc.toString(), Device.class, Sensor.class);
