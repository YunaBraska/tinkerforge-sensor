...
public class GeneratorSensorRegistry {
    ...
    public static JavaFile generate(final List<JFile> sensors) {
        ...
        javadoc.append("<i>contains mapping of ").append("{@link ").append("$T").append("} and ").append("{@link ").append("$T").append("}</i><br>").append(SEPARATOR);
        javadoc.append("<i>Autogenerated with [").append(trace.getFileName().replace(".java", "")).append(":").append(trace.getMethodName()).append("]").append("</i><br>").append(SEPARATOR);
        javadoc.append("<hr>").append(SEPARATOR);
