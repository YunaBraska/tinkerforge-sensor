...
public class GeneratorCompare {
    ...
    private static MethodSpec method_isSensor() {
        return MethodSpec.methodBuilder("is")
                ...
                .addCode("for ($T sensor : sensors) {\n", Sensor.class)
                .addCode("  if (sensor != null && sensor.uid.equals(this.sensor.uid)) {\n")
                .addCode("    return true;\n")
                .addCode("  }\n")
                .addCode("}\n")
    ...
    private static MethodSpec method_isClass() {
        return MethodSpec.methodBuilder("is")
                ...
                .addCode("for ($T sensorOrDevice : sensorOrDevices) {\n", Class.class)
                .addCode("  if (sensor.getClass() == sensorOrDevice || sensor.getType() == sensorOrDevice) {\n")
                .addCode("    return true;\n")
                .addCode("  }\n")
                .addCode("}\n")
                .addCode("return false;\n")
